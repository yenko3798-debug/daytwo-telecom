        ...
        <div className="mx-auto w-full max-w-5xl py-12">
          ...
          <div className="grid grid-cols-1 gap-4">
              <Section title="1. Acceptance of Terms">
                <p>By accessing or using the AURA Telecom platform (the &ldquo;Service&rdquo;), you agree to be bound by these Terms of Service (&ldquo;Terms&rdquo;). If you do not agree, do not use the Service.</p>
            </Section>
